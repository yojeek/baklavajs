...
export abstract class AbstractGraphNode extends AbstractNode implements IGraphNode {
    public abstract template: GraphTemplate;
    ...
    public override calculate: CalculateFunction<Record<string, any>, Record<string, any>> = async (
        ...
        if (typeof context.engine === "object" && !!context.engine && typeof context.engine.runGraph === "function") {
...
export function createGraphNodeType(template: GraphTemplate): new () => AbstractNode & IGraphNode {
    return class GraphNode extends AbstractGraphNode implements IGraphNode {
